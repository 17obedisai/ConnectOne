...
import { getLevelImage } from '@/config/levelImages'; // AÑADE ESTA LÍNEA
...
const EnergikoPanda = ({
  ...
  // REEMPLAZA la función getPandaImageForLevel con esta:
  const getPandaImageForLevel = (level) => {
    return getLevelImage(level); // Usa la función que creamos
  };
  ...
  const resolveImageSrc = () => {
    ...
    const pandaImages = {
      logo: '/images/panda-logo.png',        // CAMBIA ESTAS RUTAS
      landing: '/images/panda-landing.png',   // para usar las imágenes
      profile: '/images/panda-profile.png',   // que tienes en public/images
      dashboard: '/images/panda-dashboard.png',
