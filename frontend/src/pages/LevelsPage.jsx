  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Sube de nivel y desbloquea nuevas apariencias para Enérgiko."
        />
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto py-8">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-2">
                Sube de nivel completando actividades y mira cómo evoluciona tu
                compañero.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {levelData.map((levelInfo, index) => (
              ...
              >
                <Card
                  className={`text-center h-full flex flex-col transition-all duration-300 group ${
                ...
                >
                  <CardHeader className="flex-grow">
                    ...
                    <CardTitle className="text-foreground mt-4 !text-xl">
                      Nivel {levelInfo.level}
                    </CardTitle>
                    <p className="font-semibold text-primary h-12 flex items-center justify-center">
                      {levelInfo.name}
                    </p>
                  </CardHeader>
